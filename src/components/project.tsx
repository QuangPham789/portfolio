...
function Project({
    ...
    return (
        ...
        >
            ...
            overflow-hidden sm:pr-8 rounded-lg relative sm:h-[20rem] mb-3 sm:mb-8 last:mb-0
            group-even:pl-8 hover:bg-gray-200 transition">
                <div className="pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%]
            flex flex-col h-full group-even:ml-[26rem]">
                ...
                <Image
                    className="absolute top-8 -right-40 w-[28.5rem] rounded-t-lg shadow-2xl
                transition
